...
question: 'JAVA is object oriented language?', options: ['True', ‘False'],
answer: 'True',
...
question: 'Is the JAVA is platform independent?', options: ['Yes', 'No''],
answer: 'Yes',
...
question: 'Which team won the IPL Cup in 2023?', options: ['MI', 'SRH', 'CSK', 'RCB'],
answer: 'CSK',
...
question: 'Which is the longest river in India?', options: [
'The Nile', 'The Narmada', 'The Ganga',
...
question: 'How many moons rotates around the jupiter?', options: [‘1', '63', '24', '45'],
answer: '63',
...
options: ['code finder', 'code reusability', 'complier', 'code accepter'], answer: ‘code reusability',
},
...
const selectedOption = document.querySelector('input[name="quiz"]:checked'); if (selectedOption) {
